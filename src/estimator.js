const covid19ImpactEstimator = (data) => {
  ...
  const beds = Math.floor(0.35 * data.totalHospitalBeds) - Math.floor(0.15 * periodInfected);
  const sBeds = Math.floor(0.35 * data.totalHospitalBeds) - Math.floor(0.15 * severePeriodInfected);
  ...
  const severeImpact = {
    ...
    hospitalBedsByRequestedTime: sBeds,
