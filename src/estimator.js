const covid19ImpactEstimator = (data) => {
  ...
  const beds = Math.ceil(0.35 * data.totalHospitalBeds) - Math.floor(0.15 * periodInfected);
  const sBeds = Math.ceil(0.35 * data.totalHospitalBeds) - Math.floor(0.15 * severePeriodInfected);
