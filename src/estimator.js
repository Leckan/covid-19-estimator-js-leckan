const covid19ImpactEstimator = (data) => {
  ...
  const beds = Math.round(0.35 * data.totalHospitalBeds) - Math.ceil(0.15 * periodInfected);
  const sBeds = Math.round(0.35 * data.totalHospitalBeds) - Math.ceil(0.15 * severePeriodInfected);
