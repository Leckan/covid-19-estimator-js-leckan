const covid19ImpactEstimator = (data) => {
  ...
  const beds = Math.floor(0.35 * data.totalHospitalBeds) - Math.ceil(0.15 * periodInfected);
  const sBeds = Math.floor(0.35 * data.totalHospitalBeds) - Math.ceil(0.15 * severePeriodInfected);
