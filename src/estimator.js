const covid19ImpactEstimator = (data) => {
  ...
  const beds = Math.floor((data.totalHospitalBeds * 0.35) - (periodInfected * 0.15));
  const severeBeds = Math.floor((data.totalHospitalBeds * 0.35) - (severePeriodInfected * 0.15));
